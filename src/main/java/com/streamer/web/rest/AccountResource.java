...
import com.streamer.domain.User;
import com.streamer.repository.UserRepository;
import com.streamer.security.SecurityUtils;
import com.streamer.service.MailService;
import com.streamer.service.UserService;
import com.streamer.web.rest.dto.KeyAndPasswordDTO;
import com.streamer.web.rest.dto.ManagedUserDTO;
import com.streamer.web.rest.dto.UserDTO;
        ...
        return userRepository.findOneByLogin(managedUserDTO.getLogin().toLowerCase())
            ...
            .orElseGet(() -> userRepository.findOneByEmail(managedUserDTO.getEmail())
                ...
                .orElseGet(() -> {
                    ...
                    managedUserDTO.getFirstName(), managedUserDTO.getLastName(), managedUserDTO.getCompany(), managedUserDTO.getEmail().toLowerCase(),
